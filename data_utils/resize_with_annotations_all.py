...
anno_path = r'C:\Users\a.sudupe\Desktop\TFG\Datasets\backup\annotations_all/'
img_path = r'C:\Users\a.sudupe\Desktop\TFG\Datasets\backup\images_small_original/'

dest_path = r'C:\Users\a.sudupe\Desktop\TFG\Datasets\backup\Dataset1k/'
...
for im in imgs:
    image = cv2.imread(img_path + '/' + im)
    image = cv2.resize(image, (r, r))
    cv2.imwrite(dest_path + 'images/' + im, image)
...
with open(dest_path + 'annotations/COCO.json', "w") as outfile: 
